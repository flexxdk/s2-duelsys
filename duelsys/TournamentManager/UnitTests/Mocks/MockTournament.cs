...
namespace UnitTests.Mocks
{
    public class MockTournament : ITournamentRepository
    {
        ...
        public MockTournament()
        {
            ...
            {
                new TournamentDTO(++trnSeeder, "BAD!-Minton Championship", true, 8, 32, DateTime.UtcNow.ToString("d"), DateTime.UtcNow.AddDays(7).ToString("d"), "SingleElimination"),
                new TournamentDTO(++trnSeeder, "GOOD!-Minton Championship", true, 4, 16, DateTime.UtcNow.AddDays(8).ToString("d"), DateTime.UtcNow.AddDays(13).ToString("d"), "RoundRobin"),
                new TournamentDTO(++trnSeeder, "Regular-Minton Cup", true, 10, 20, DateTime.UtcNow.AddDays(20).ToString("d"), DateTime.UtcNow.AddDays(30).ToString("d"), "RoundRobin")
            };
        ...
        {
            tournaments.Add(new TournamentDTO(++trnSeeder, dto.Name, dto.AllowRegistration, dto.MinContestants, dto.MaxContestants, dto.StartDate, dto.EndDate, dto.System));
            return trnSeeder;
        }
